...
verifyTxUtxo ctx@VTxContext {..} blacklist ta@(TxAux UnsafeTx {..} witnesses) = do
  ...
  where
    ...
    -- of the software. Before decentralisation, the blacklist can provide extra protection for
    -- the Ada held by these entities. It is intended that this blacklist functionality will be
